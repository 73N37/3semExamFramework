...
public class DAO extends dat.Factory.Operation.DAO.Abstract
{
    ...
    {
        super(_emf,entityClass, dtoClass, idClass);
    }
    ...
    public static class Access{
        ...
        public dat.Factory.Information.Entity.BaseEntity
        getEntity(java.lang.Class<? extends java.io.Serializable> id)
        {
            return DAO.get(id);
        }

        public java.util.Set<dat.Factory.Information.Entity.BaseEntity>
        getAllEntities()
        {
            return DAO.getAll();
        }
        ...
        public dat.Factory.Information.Entity.BaseEntity
        putEntity(dat.Factory.Information.Entity.BaseEntity entity)
        {
        ...
        public void
        deleteEntity(dat.Factory.Information.Entity.BaseEntity entity){
...
//    }
//
//    private static dat.Factory.Information.Entity.BaseEntity
...
//    }
//
//    private static java.util.Set<dat.Factory.Information.Entity.BaseEntity>
//    getAll()
//            throws dat.Factory.Exception.DAOException
//    {
//        try (jakarta.persistence.EntityManager em = emf.createEntityManager())
